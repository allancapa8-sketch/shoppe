...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(seller_id, name, details, price, image_01, image_02, image_03) VALUES(?,?,?,?,?,?,?)");
      $insert_products->execute([$seller_id, $name, $details, $price, $image_01, $image_02, $image_03]);
...
if(isset($_GET['delete'])){
   ...
   $delete_product_image = $conn->prepare("SELECT * FROM `products` WHERE id = ? AND seller_id = ?");
   $delete_product_image->execute([$delete_id, $seller_id]);
   if($delete_product_image->rowCount() > 0){
   ...
   <div class="container">
      ...
      ?>
         <div class="col" data-aos="fade-up">
            <div class="card seller-product-card shadow-sm border-0 h-100">
      ...
      <?php
            ...
            echo '<p class="empty">No products added yet! Start by adding your first product above.</p>';
         }
      ?>
      </div>
   </div>
